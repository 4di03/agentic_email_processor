...
if __name__ == "__main__":
    ...
    email_to_event_service = init_email_to_event_service(model=model, with_critic=False, dry_run = not args.real_run, response_format= EmailSummaryResponseFormatDebug)
